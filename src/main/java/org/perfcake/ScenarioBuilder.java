...
public class ScenarioBuilder {
   ...
   private Map<String, MessageValidator> validators = new HashMap<>();
   ...
   public Scenario build() throws Exception {
      ...
      for (String id : validators.keySet()) {
         ValidatorManager.addValidator(id, validators.get(id));
      }
