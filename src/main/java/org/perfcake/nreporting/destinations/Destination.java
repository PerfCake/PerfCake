 ...
 * Destinations are registered with {@link org.perfcake.nreporting.reporters.Reporter Reporters} and are completely controlled by them. The only responsibility of a destination is to open
 * a reporting channel, report measurements, and close the reporting channel.
 * It is the role of {@link org.perfcake.nreporting.Measurement} to provide all the information
...
public interface Destination extends Closeable {
   ...
   /**
    * Report a new {@link org.perfcake.nreporting.Measurement} to the destination.
    * 
    * @param m
